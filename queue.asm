...
; -----------------------------------------------------------------------------
; qPop: pop a value from the queue
; -----------------------------------------------------------------------------
!macro qPop index {
  ldx index
  jsr qPop
...
; -----------------------------------------------------------------------------
; qFront: get offset to front of queue
; -----------------------------------------------------------------------------
!macro qFront index {
  ldx index
...
; -----------------------------------------------------------------------------
; qBack: get offset to back of queue
; -----------------------------------------------------------------------------
!macro qBack index {
  pha
  lda index
...
; -----------------------------------------------------------------------------
; qIterate: iterate a queue
; -----------------------------------------------------------------------------
!macro qIterate index {
  ldx index
  jsr qIterate
}

; -----------------------------------------------------------------------------
; qSize: return size of queue
; -----------------------------------------------------------------------------
!macro qSize index {
  ldx index
  jsr qSize
...
; -----------------------------------------------------------------------------
; qBack: get offset to front of queue
; -----------------------------------------------------------------------------
; inputs:
;   X: queue index
; returns
